...
import com.ms.Order.factory.OrderResponseFactory;
    ...
    class ListOrders {
        ...
        void shouldReturnHttpOk() {
            ...
            doReturn(BigDecimal.valueOf(20.50))
                    .when(service).findTotalOnOrdersByCustomerId(anyLong());
        ...
        void shouldPassCorrectParametersToService() {
            ...
            var pageSize = 10;
            doReturn(OrderResponseFactory.buildWithOneItem())
                    .when(service).findAllByCustomerId(customerIdCaptor.capture(), pageRequestCaptor.capture());
            doReturn(BigDecimal.valueOf(20.50))
                    .when(service).findTotalOnOrdersByCustomerId(customerIdCaptor.capture());
